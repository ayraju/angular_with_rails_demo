...
;
 ...
 spa_app.controller('myAboutController', function($scope){
  ...
  spa_app.controller('myProjectIndexController', function($scope,$http){
   $http.get("http://protected-falls-9403.herokuapp.com/api/v1/list_of_projects").success(function(res){
  ...
  spa_app.controller('createProjectController', function($scope,$http,$location){
    $scope.update = function(project){
     ...
     $http({method: "POST", url: "http://protected-falls-9403.herokuapp.com/api/v1/create_project", data: {title: project.title, description: project.description} }).success(function(data) {        
